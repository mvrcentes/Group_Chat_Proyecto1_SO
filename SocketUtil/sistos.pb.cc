...
// source: sistos-2.proto

#include "sistos-2.pb.h"
...
static ::PROTOBUF_NAMESPACE_ID::Metadata file_level_metadata_sistos_2d2_2eproto[8];
static constexpr ::PROTOBUF_NAMESPACE_ID::EnumDescriptor const** file_level_enum_descriptors_sistos_2d2_2eproto = nullptr;
static constexpr ::PROTOBUF_NAMESPACE_ID::ServiceDescriptor const** file_level_service_descriptors_sistos_2d2_2eproto = nullptr;

const ::PROTOBUF_NAMESPACE_ID::uint32 TableStruct_sistos_2d2_2eproto::offsets[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
...
const char descriptor_table_protodef_sistos_2d2_2eproto[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) =
  "\n\016sistos-2.proto\022\004chat\"N\n\020UserRegistrati"
  ...
  "changeb\006proto3"
  ;
static ::PROTOBUF_NAMESPACE_ID::internal::once_flag descriptor_table_sistos_2d2_2eproto_once;
const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable descriptor_table_sistos_2d2_2eproto = {
  false, false, 1254, descriptor_table_protodef_sistos_2d2_2eproto, "sistos-2.proto", 
  &descriptor_table_sistos_2d2_2eproto_once, nullptr, 0, 8,
  schemas, file_default_instances, TableStruct_sistos_2d2_2eproto::offsets,
  file_level_metadata_sistos_2d2_2eproto, file_level_enum_descriptors_sistos_2d2_2eproto, file_level_service_descriptors_sistos_2d2_2eproto,
};
PROTOBUF_ATTRIBUTE_WEAK ::PROTOBUF_NAMESPACE_ID::Metadata
descriptor_table_sistos_2d2_2eproto_metadata_getter(int index) {
  ::PROTOBUF_NAMESPACE_ID::internal::AssignDescriptors(&descriptor_table_sistos_2d2_2eproto);
  return descriptor_table_sistos_2d2_2eproto.file_level_metadata[index];
}

// Force running AddDescriptors() at dynamic initialization time.
PROTOBUF_ATTRIBUTE_INIT_PRIORITY static ::PROTOBUF_NAMESPACE_ID::internal::AddDescriptorsRunner dynamic_init_dummy_sistos_2d2_2eproto(&descriptor_table_sistos_2d2_2eproto);
namespace chat {
